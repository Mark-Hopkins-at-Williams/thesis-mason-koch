...
async def main():
    ...
    time.sleep(0.01)
    await newclient.challenge_user('aiDebugNotABattle', 'gen7customgame', 'Arceus|arceusfighting|fistplate|multitype|thunderbolt,shadowclaw,aerialace,judgment||85,,85,85,85,85|N|,0,,,,||81|')
    roomname = ""
