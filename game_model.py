...
if FNAME == "swellow_aggron":
    ...
    OPPONENT_TEAM_MAXHEALTH = [302, 402, 0, 344, 0, 312]    # SMOGON SAYS 344 HEALTH FOR DRAGONITE, BUT IT HASN'T CRASHED IN TRAINING??? AH, THE ASSERTION IS NOT IN TRAINIG. FIX THIS.
