...
OUR_TEAM_MAXHEALTH = [0, 272, 0, 334, 282, 0]
#OUR_TEAM_MAXHEALTH = [243, 327, 0, 343, 0, 0]
OPPONENT_TEAM_MAXHEALTH = [243, 327, 0, 343, 0, 0]
#OPPONENT_TEAM_MAXHEALTH = [0, 272, 0, 334, 282, 0]
