...
const p2spec = {
	name: "HughMann",
	team: 'Dugtrio||choicescarf|arenatrap|earthquake,stoneedge,shadowclaw,memento|adamant|,252,4,,,252||||100|]Mandibuzz||heavy-dutyboots|overcoat|foulplay,roost,u-turn,defog|careful|252,,,,160,96||||100|]Toxapex||blacksludge|regenerator|scald,recover,haze,toxic|bold|252,,252,,4,||||100|]Excadrill||leftovers|moldbreaker|earthquake,ironhead,rapidspin,swordsdance|jolly|,252,4,,,252||||100|]Dragapult||spelltag|infiltrator|hex,will-o-wisp,dracometeor,u-turn|timid|,,,252,4,252||||100|]Ferrothorn||leftovers|ironbarbs|spikes,bodypress,knockoff,leechseed|impish|252,,252,,4,||||100|',
};
