...
const p1spec = {
	name: "Alice",
	team: 'Sylveon||leftovers|pixilate|hypervoice,wish,protect,calmmind|calm|252,,4,,252,||||100|]Corviknight||leftovers|pressure|ironhead,defog,roost,bodypress|careful|252,,48,,208,||||100|]Toxapex||blacksludge|regenerator|scald,recover,haze,toxic|bold|252,,252,,4,||||100|]Hippowdon||leftovers|sandstream|earthquake,slackoff,stealthrock,whirlwind|impish|252,,252,,4,||||100|]Excadrill||leftovers|moldbreaker|earthquake,ironhead,rapidspin,swordsdance|jolly|,252,4,,,252||||100|]Hydreigon||lifeorb|levitate|nastyplot,dracometeor,flashcannon,flamethrower|timid|,,,252,4,252||||100|',
};
const p2spec = {
	name: "HughMann",
