...
const p2spec = {
	name: "HughMann",
	team: 'Toxapex||blacksludge|regenerator|scald,recover,haze,toxic|bold|252,,252,,4,||||100|]Dugtrio||choicescarf|arenatrap|earthquake,stoneedge,shadowclaw,memento|adamant|,252,4,,,252||||100|]Corviknight||leftovers|pressure|ironhead,defog,roost,bodypress|careful|252,,48,,208,||||100|]Rotom-heat||heavy-dutyboots|levitate|nastyplot,overheat,voltswitch,toxic|timid|248,,,8,,252||||100|]Tyranitar||choiceband|sandstream|stoneedge,crunch,earthquake,firepunch|adamant|,252,,,4,252||||100|]Sylveon||leftovers|pixilate|hypervoice,wish,protect,calmmind|calm|252,,4,,252,||||100|',
};
