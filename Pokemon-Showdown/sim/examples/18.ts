...
const p2spec = {
	name: "HughMann",
	team: 'Clefable||leftovers|magicguard|teleport,moonblast,wish,protect|calm|252,,4,,252,||||100|]Rotom-heat||heavy-dutyboots|levitate|nastyplot,overheat,voltswitch,toxic|timid|248,,,8,,252||||100|]Seismitoad||leftovers|waterabsorb|stealthrock,toxic,earthpower,scald|bold|252,,252,,4,||||100|]Hydreigon||lifeorb|levitate|nastyplot,dracometeor,flashcannon,flamethrower|timid|,,,252,4,252||||100|]Corviknight||leftovers|pressure|ironhead,defog,roost,bodypress|careful|252,,48,,208,||||100|]Dragapult||spelltag|infiltrator|hex,will-o-wisp,dracometeor,u-turn|timid|,,,252,4,252||||100|',
};
