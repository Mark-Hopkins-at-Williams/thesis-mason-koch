...
const p1spec = {
	name: "Alice",
	team: 'Gengar||choicescarf|cursedbody|shadowball,sludgewave,focusblast,trick|timid|,,,252,4,252||||100|]Hydreigon||lifeorb|levitate|nastyplot,dracometeor,flashcannon,flamethrower|timid|,,,252,4,252||||100|]Seismitoad||leftovers|waterabsorb|stealthrock,toxic,earthpower,scald|bold|252,,252,,4,||||100|]Clefable||leftovers|magicguard|teleport,moonblast,wish,protect|calm|252,,4,,252,||||100|]Mandibuzz||heavy-dutyboots|overcoat|foulplay,roost,u-turn,defog|careful|252,,,,160,96||||100|]Rotom-heat||heavy-dutyboots|levitate|nastyplot,overheat,voltswitch,toxic|timid|248,,,8,,252||||100|',
};
const p2spec = {
	name: "HughMann",
