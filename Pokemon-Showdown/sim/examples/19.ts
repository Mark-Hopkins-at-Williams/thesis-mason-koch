...
const p2spec = {
	name: "HughMann",
	team: 'Clefable||leftovers|magicguard|teleport,moonblast,wish,protect|calm|252,,4,,252,||||100|]Mandibuzz||heavy-dutyboots|overcoat|foulplay,roost,u-turn,defog|careful|252,,,,160,96||||100|]Dugtrio||choicescarf|arenatrap|earthquake,stoneedge,shadowclaw,memento|adamant|,252,4,,,252||||100|]Excadrill||leftovers|moldbreaker|earthquake,ironhead,rapidspin,swordsdance|jolly|,252,4,,,252||||100|]Toxapex||blacksludge|regenerator|scald,recover,haze,toxic|bold|252,,252,,4,||||100|]Kommo-o||leftovers|bulletproof|bodypress,stealthrock,earthquake,irondefense|impish|252,,200,,,56||||100|',
};
